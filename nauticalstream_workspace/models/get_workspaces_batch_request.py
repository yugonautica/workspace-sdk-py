...
class GetWorkspacesBatchRequest(BaseModel):
    """
    GetWorkspacesBatchRequest
    """ # noqa: E501
    ids: Optional[List[StrictInt]] = None
    handles: Optional[List[StrictStr]] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if handles (nullable) is None
        # and model_fields_set contains the field
        if self.handles is None and "handles" in self.model_fields_set:
            _dict['handles'] = None
