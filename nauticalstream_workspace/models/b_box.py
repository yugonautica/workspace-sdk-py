...
class BBox(BaseModel):
    ...
    north_east: LatLng
    south_west: LatLng
    __properties: ClassVar[List[str]] = ["north_east", "south_west"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "north_east": LatLng.from_dict(obj["north_east"]) if obj.get("north_east") is not None else None,
            "south_west": LatLng.from_dict(obj["south_west"]) if obj.get("south_west") is not None else None
        })
        return _obj
