...
class HealthApi:
    ...
    def liveness_check(
        ...
        Liveness endpoint. Always returns 200 if the server process is alive.
    ...
    @validate_call
    def liveness_check_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def liveness_check_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def readiness_check(
        ...
        Readiness endpoint. Returns 200 if DB is reachable, 503 otherwise.
