...
class GetFeaturesBatchRequest(BaseModel):
    ...
    workspace_ids: Optional[List[StrictInt]] = None
    amenity_ids: Optional[List[StrictInt]] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if amenity_ids (nullable) is None
        # and model_fields_set contains the field
        if self.amenity_ids is None and "amenity_ids" in self.model_fields_set:
            _dict['amenity_ids'] = None
