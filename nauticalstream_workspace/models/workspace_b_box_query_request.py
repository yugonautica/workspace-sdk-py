...
class WorkspaceBBoxQueryRequest(BaseModel):
    """
    WorkspaceBBoxQueryRequest
    """ # noqa: E501
    bbox: BBox
    filters: Optional[WorkspaceBBoxFilters] = None
    __properties: ClassVar[List[str]] = ["bbox", "filters"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "filters": WorkspaceBBoxFilters.from_dict(obj["filters"]) if obj.get("filters") is not None else None
        })
        return _obj
